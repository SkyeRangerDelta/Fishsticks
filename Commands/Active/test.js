...
exports.run = async (fishsticks, msg, cmd) => {
    ...
    if (msg.author == fishsticks.ranger) {
        ...
        return msg.reply("Whoa whoa, no. The hardest choices require the strongest wills. This is one such command that you cannot run.").then(sent => sent.delete(10000));
    }
